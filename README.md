...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-iua-qlo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-iua-qlo.containers.anotherwebservice.com/
...
```
git clone git@github.com:joeltejeda/container-iua-qlo.git
cd container-iua-qlo
```
...
```
docker attach container-iua-qlo
```
